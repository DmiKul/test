...
export class CreateTaskComponent {
  ...
  private readonly relativePath = this.isStackblitz
    ? 'https://taiga-ui.dev/'
    : '';
  ...
  // editorTools = [TuiEditorTool.Bold, TuiEditorTool.Italic, TuiEditorTool.Link];
  // editorExtensions = TUI_EDITOR_EXTENSIONS;
  // editorMaxImageWidth = TUI_EDITOR_MAX_IMAGE_WIDTH;
  // editorMinImageWidth = TUI_EDITOR_MIN_IMAGE_WIDTH;
  // imageLoader = TUI_IMAGE_LOADER;
